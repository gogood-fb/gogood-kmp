...
@NonNullApi
public class GoGoodProjectDependency extends DelegatingProjectDependency {

    @Inject
    public GoGoodProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
